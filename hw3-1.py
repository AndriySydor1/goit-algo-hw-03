...
Функція повертає ціле число, яке вказує на кількість днів від заданої дати до поточної. Якщо задана дата раніша за поточну, результат має бути від'ємним.
...
print(f"Якщо сьогодні {today}, виклик get_days_from_today('2021-10-09') повертає: {result}")
